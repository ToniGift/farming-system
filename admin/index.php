...
<head>
    <meta charset="utf-8" />
    <title>Farming System - Admin Login</title>
                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-lg-6 p-5">
                                    <div class="mx-auto mb-5">
                                        <a href="./">
                                            ...
                                            <h3 class="d-inline align-middle ml-1 text-logo">Farming System</h3>
                                        </a>
                                    </div>
                                ...
                                <div class="col-lg-6 d-none d-md-inline-block">
                                    <div class="auth-page-sidebar" style="background-image: url('../images/bg/re.jpg');">
